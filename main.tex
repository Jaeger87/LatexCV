...
\section{About me}
Backend \& AI engineer with a background in game development and embedded systems. Hands-on experience shipping production apps and services (Go, iOS/Android, Unity/Unreal), building reliable workflows (Temporal, CI), and contributing to open-source and tech communities.
\section{Contact}
...
The platform runs on \textbf{AWS}, with \textbf{Firebase} and \textbf{Firestore} used for user data and application state management. Infrastructure is managed via \textbf{Terraform}, enabling reproducible and scalable cloud deployments.
...
\begin{itemize}
 ...
 \item I took on the task of creating a Continuous Integration (CI) system from scratch by using \textbf{Gitlab}. This system was specifically designed to work smoothly with Unity, enhancing collaboration and streamlining the development workflow.
...
Lab2GO is a university project focused on retraining Italian high school laboratories and delivering hands-on lessons to students. The project is part of the “Alternanza Scuola Lavoro” program. My main tasks included assisting students in the lab, supporting them in learning and developing \textbf{physics experiments} with the \href{https://www.marrtino.org/}{MARRtino} robot.}
%------------------------------------------------
